    ...
    <div className="min-h-screen bg-[#111318] px-6 py-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {project.status === 'pending' && (
          <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 px-4 py-4 space-y-3">
            <div className="flex items-start gap-3">
            ...
            <div className="pl-8">
              <button
                ...
                onClick={handleRetry}
                disabled={retrying}
                className="inline-flex items-center gap-1.5 rounded-md border border-yellow-500/30 bg-yellow-500/10 px-3 py-1.5 text-xs font-semibold text-yellow-300 hover:bg-yellow-500/20 disabled:opacity-50 transition-colors"
              >
                {retrying ? (
                  <Loader2 className="w-3.5 h-3.5 animate-spin" />
                ) : (
