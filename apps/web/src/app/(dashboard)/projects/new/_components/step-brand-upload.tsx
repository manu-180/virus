...
export function StepBrandUpload({ projectId, onNext, onBack, onFileUploaded }: Props) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append('kind', 'project_info');
  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        <h2 className="text-2xl font-bold">Info de marca</h2>
        <p className="text-muted-foreground text-sm mt-1">
          Subí tu documento con la información de tu marca o empresa.
        </p>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <TemplateDownloadButton kind="brand" />
      </div>
      ...
      >
        <input
          ref={fileInputRef}
          type="file"
          aria-label="Seleccionar archivo de info de marca"
